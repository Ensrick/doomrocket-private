...
BTDoomrocketReloadAction.name = "BTDoomrocketReloadAction"

BTDoomrocketReloadAction.init = function (self, ...)
	BTDoomrocketReloadAction.super.init(self, ...)
end
...
BTDoomrocketReloadAction.leave = function (self, unit, blackboard, t, reason, destroy)
...
BTDoomrocketReloadAction.run = function (self, unit, blackboard, t, dt)
