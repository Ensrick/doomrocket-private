...
Assert-True ($itemConfig -match '(?m)^title\s*=\s*"Warprocket Bombardier TEST v0.1.70-dev";\s*$') `
    "development title must be exactly Warprocket Bombardier TEST v0.1.70-dev"
