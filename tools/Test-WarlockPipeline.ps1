...
Assert-True ($itemConfig -match '(?m)^title\s*=\s*"Warprocket Bombardier TEST v0.1.72-dev";\s*$') `
    "development title must be exactly Warprocket Bombardier TEST v0.1.72-dev"
